...
A modern, feature-rich frontend-only Kanban task management application built with React, Redux Toolkit, and Redux Saga. Perfect for demonstrating best practices in React architecture with simulated backend interactions.

Live Demo • Features • Installation • Deployment • Docs
